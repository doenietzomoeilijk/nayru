...
class ArrayObject extends \ArrayObject
{
     ...
     */
    const DEFAULT_SERIALIZER = '\Nayru\Serializer\Php';

    /**
     * The serializer to use when serializing the data.
     *
     * @var \Nayru\Serializer $serializer
     */
     ...
     * Set the serializer.
     *
     * @param \Nayru\Serializer $serializer
     */
    public function setSerializer(\Nayru\Serializer $serializer)
    {

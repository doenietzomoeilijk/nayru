 ...
 * Configuration.
 */
class Configuration extends \Nayru\ArrayObject
{
    /**
     * The storage in which the configuration is stored.
     *
     * @var \Nayru\Storage\Adapter $storage
     */
    protected $storage;
     ...
     *
     * @param \Nayru\Storage\Adapter $adapter
     * @return void
     */
    public function setStorage(\Nayru\Storage\Adapter $adapter)
    {

...
namespace Tests\Nayru\Serializer;

use \Nayru\Serializer\JsonConf;

/**
 * JsonConfTest.
 */
class JsonConfTest extends \Tests\Nayru\Serializer\TestBase
{
    /**
     ...
     */
    protected $serializerClass = '\Nayru\Serializer\JsonConf';
